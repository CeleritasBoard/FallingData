...
import {Card, CardTitle, CardHeader, CardContent} from "@workspace/ui/src/components/card.tsx";
import { Table, TableBody, TableCell, TableHead, TableHeader, TableRow } from "@workspace/ui/src/components/table.tsx";
...
export default async function commandDataPage({params}:
                        ...
                        <Card className="lg:col-span-2">
                            ...
                            <CardContent>
                                <Table>
                                    ...
                                    <TableBody>
                                        <TableRow>
                                            <TableCell className="text-muted-foreground">Típus: </TableCell>
                                            <TableCell> {parameters.type}</TableCell>
                                        </TableRow>

                                        {command.type === "SET_SCALE" && (
                                            <><TableRow>
                                                <TableCell className="text-muted-foreground">Mérési tartomány
                                                    minimuma: </TableCell>
                                                <TableCell>{parameters.params.lowerThreshold}</TableCell>
                                            </TableRow><TableRow>
                                                <TableCell className="text-muted-foreground">Mérési tartomány
                                                    maximuma: </TableCell>
                                                <TableCell>{parameters.params.upperThreshold}</TableCell>
                                            </TableRow><TableRow>
                                                <TableCell className="text-muted-foreground">A mérési tartomány
                                                    felbontása: </TableCell>
                                                <TableCell>{parameters.params.resolution}</TableCell>
                                            </TableRow><TableRow>
                                                <TableCell className="text-muted-foreground">A mintavételezés
                                                    gyakorisága: </TableCell>
                                                <TableCell>{parameters.params.upperThreshold}</TableCell>
                                            </TableRow></>
                                        ...
                                        {command.type === "SET_DURATION" && (
                                            <><TableRow>
                                                <TableCell className="text-muted-foreground">Ismétlések
                                                    száma: </TableCell>
                                                <TableCell>{parameters.params.repetitions}</TableCell>
                                            </TableRow><TableRow>
                                                <TableCell className="text-muted-foreground">Mód: </TableCell>
                                                <TableCell>{parameters.params.mode}</TableCell>
                                            </TableRow><TableRow>
                                                <TableCell className="text-muted-foreground">Okaying: </TableCell>
                                                <TableCell>{parameters.params.okaying.toString()}</TableCell>
                                            </TableRow><TableRow>
                                                <TableCell className="text-muted-foreground">Mérési idő: </TableCell>
                                                <TableCell>{parameters.params.duration}</TableCell>
                                            </TableRow><TableRow>
                                                <TableCell className="text-muted-foreground">Szünet a mérések
                                                    között: </TableCell>
                                        ...
                                        {command.type === "REQUEST_MEASUREMENT" && (
                                            <><TableRow>
                                                <TableCell className="text-muted-foreground">A mérés kivitelezésének
                                                    időpontja: </TableCell>
                                                <TableCell>{parameters.params.timestamp}</TableCell>
                                            </TableRow><TableRow>
                                                <TableCell className="text-muted-foreground">Folytatás betelt
                                                    csatornával: </TableCell>
                                                <TableCell>{parameters.params.continue_with_full_channel.toString()}</TableCell>
                                            </TableRow><TableRow>
                                                <TableCell className="text-muted-foreground">Header: </TableCell>
                                                <TableCell>{parameters.params.header_packet.toString()}</TableCell>
                                            </TableRow></>
                                        )}
                                        {command.type === "REQUEST_SELFTEST" && (
                                            <><TableRow>
                                                <TableCell className="text-muted-foreground">A selftest kiküldésének
                                                    időpontja: </TableCell>
                                                <TableCell>{parameters.params.timestamp}</TableCell>
                                            </TableRow></>
                                        )}
