...
const devices = [{ id: "BME_HUNITY" as const }, { id: "ONIONSAT_TEST" as const }, { id: "SLOTH" as const }]
...
export default function CommandScheduleForm({ onSubmit }: CommandScheduleFormProps) {
    const form = useForm<FormValues>({
        resolver: zodResolver(formSchema),
        defaultValues: {
            device: "BME_HUNITY",
            type: "SET_DUR",
            executionDate: "2025.10.15 14:55:55",
                                            ...
                                            {devices.map((device) => (
                                                <div
                                                    ...
                                                    className={`cursor-pointer rounded-lg transition-all ${
                                                        field.value === device.id ? "ring-2 ring-blue-500 ring-offset-2" : "hover:opacity-80"
                                                    }`}>
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    ...
                                    <Select onValueChange={field.onChange} defaultValue={field.value}>
                                        ...
                                        <SelectContent>
                                            <SelectItem value="FORCE_STATUS_REPORT">FORCE STATUS REPORT</SelectItem>
                                            <SelectItem value="REQUEST_MEASUREMENT">REQUEST MEASUREMENT</SelectItem>
                                            <SelectItem value="REQUEST_SELFTEST">REQUEST SELFTEST</SelectItem>
                                            <SelectItem value="RESET">RESET</SelectItem>
                                            <SelectItem value="RESTART">RESTART</SelectItem>
                                            <SelectItem value="SAVE">SAVE</SelectItem>
                                            <SelectItem value="SET_DUR">SET DUR</SelectItem>
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    ...
                                    <FormControl>
                                        <Input type="text" className="w-[200px]" placeholder="YYYY.MM.DD HH:MM:SS" {...field} />
                                    </FormControl>
                                </FormItem>
                            )}
                        />
